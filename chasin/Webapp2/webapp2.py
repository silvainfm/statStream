...
if authentication_status:
    ...
    def get_data_from_excel(sheet):
        path_excel = Path(__file__).parents[1] / 'Webapp2/pdf_analysis212c.xlsx'
        df = pd.read_excel(
            io = path_excel,
            engine = 'openpyxl',
            sheet_name = sheet)
