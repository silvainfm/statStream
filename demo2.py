...
st.set_page_config(page_title='Gamma Dashboard', layout='wide')
...
st.image('images/Statstorm.png', caption = 'powered by StatStorm', width = 400 )
...
if authentication_status:
    ...
    grid_response = AgGrid(
        ...
        enable_enterprise_modules=False, #displays filter if true
        height=350, 
        reload_data=True
    )
